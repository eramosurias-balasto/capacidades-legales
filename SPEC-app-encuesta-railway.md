...
- URL real del aviso de privacidad (hay placeholder).
- Nombres reales de las tres instituciones y slugs definitivos (hay seed placeholder; considerar slugs no adivinables, p. ej. `inst-a-x7k2`).
